...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    "        <td ng-show=\"showSeconds\"><a ng-click=\"incrementSeconds()\" class=\"btn btn-link\"><i class=\"icon-chevron-up\"></i></a></td>\n" +
    ...
    "        <td ng-show=\"showSeconds\">:</td>\n" +
    "        <td ng-show=\"showSeconds\" class=\"control-group\" ng-class=\"{'error': invalidSeconds}\"><input type=\"text\" ng-model=\"seconds\" ng-change=\"updateSeconds()\" class=\"span1 text-center\" ng-readonly=\"readonlyInput\" maxlength=\"2\"></td>\n" +
    ...
    "        <td ng-show=\"showSeconds\">&nbsp;</td>\n" +
    "        <td ng-show=\"showSeconds\"><a ng-click=\"decrementSeconds()\" class=\"btn btn-link\"><i class=\"icon-chevron-down\"></i></a></td>\n" +
    "        <td ng-show=\"showMeridian\"></td>\n" +
    "	</tr>\n" +
    "</table>\n" +
    "");
